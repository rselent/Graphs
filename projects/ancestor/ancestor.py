...
def earliest_ancestor(ancestors, starting_node):
	...
	for pair in ancestors:
		...
		# If nextVal is not in table, add it
		if nextVal not in table:
			table[ nextVal] = []

		# Finally add the anchors of each nextVal to their list in the dict
		table[ nextVal].append( parent)
